  ...
  <form>
    <div class="container">
      ...
      <div class="row mb-3">
        <div class="col-md-7">
          <router-link to="/">
            <h2>CALIBRATION ROOM - DEPTH<small><small>_ 0.3.0 version</small></small></h2>
          </router-link>
        ...
        <div class="col-md-5">
          ...
          <button type="button" class="btn btn-light v-mar" @click="intrinsic_launcher"><strong>CALC INTRINSIC PARAM</strong></button>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="" :value="depth_only">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
...
tf_listener.subscribe((message: any) => {
  if (message.transforms[0].child_frame_id === 'depth_tf') {
    ...
    depth_y.value = message.transforms[0].transform.translation.y;
    depth_z.value = message.transforms[0].transform.translation.z;
    depth_roll.value = message.transforms[0].transform.rotation.x;
    depth_pitch.value = message.transforms[0].transform.rotation.y;
    depth_yaw.value = message.transforms[0].transform.rotation.z;
  }
});
...
const store_pose = async () => {
  await axios({
    ...
    data: {
      ...
      lidar_y : depth_only,
      lidar_z : depth_only,
      lidar_roll : depth_only,
      lidar_pitch : depth_only,
      lidar_yaw : depth_only,
      camera_x : depth_only,
      camera_y : depth_only,
      camera_z : depth_only,
      camera_roll : depth_only,
      camera_pitch : depth_only,
      camera_yaw : depth_only,
    }
  });
};


// *** 카메라 내부 파라미터를 저장하는 함수 *** //
const intrinsic_launcher = async () => {
  // NOT IMPLEMENTED YET
};
</script>
